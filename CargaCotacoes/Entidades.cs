...
namespace CargaCotacoes
{
    ...
    {
        public CotacaoEntity(string siglaMoeda, string dataCotacao, double valorComercial)
        {
    ...
    {
        public CotacaoDolarEntity(string siglaMoeda, string dataCotacao, double valorComercial, double valorTurismo) : base(siglaMoeda, dataCotacao, valorComercial)
        {

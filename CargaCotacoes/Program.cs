...
namespace CargaCotacoes
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Console.WriteLine("Gerar a referência da tabela e criar no storage (caso a mesma ainda não exista)...");
            ...
            Carga.ListaCotacoes<CotacaoEntity>(table, "EUR");
            ...
            Carga.ListaCotacoes<CotacaoEntity>(table, "LIB");
            ...
            Carga.ListaCotacoes<CotacaoDolarEntity>(table, "USD");
